...
pub mod tags {
    ...
    pub mod r#Tag {
        ...
        pub type r#Second<'s, S, const INHERITED: ::core::primitive::usize> =
            (&'s super::super::generics::Seq2<
                (::pest_typed::predefined_node::Skipped<
                    super::super::generics::Seq2<
                        (::pest_typed::predefined_node::Skipped<
                            super::super::generics::Seq2<
                                (::pest_typed::predefined_node::Skipped<
